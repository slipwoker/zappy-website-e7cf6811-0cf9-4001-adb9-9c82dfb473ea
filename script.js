    ...
    if (contactForm) {
        ...
        const validateField = function(input) {
            ...
            if (pattern && value) {
                ...
                if (!regex.test(value)) {
                    showError(input, input.getAttribute('data-error-pattern') || 'Please match the requested format');
                    return false;
                }
            }
        ...
        contactForm.addEventListener('blur', function(e) {
            const input = e.target.closest('input, textarea, select');
            if (!input) return;
            if (input.hasAttribute('required') || input.type === 'email' || input.hasAttribute('pattern') || input.hasAttribute('minlength')) {
                validateField(input);
            }
        }, true);
    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e7cf6811-0cf9-4001-adb9-9c82dfb473ea',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e7cf6811-0cf9-4001-adb9-9c82dfb473ea';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e7cf6811-0cf9-4001-adb9-9c82dfb473ea';
